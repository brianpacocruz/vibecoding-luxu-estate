...
export default function LoginPage() {
  ...
  const handleGoogleLogin = async () => {
    ...
    // Not setting loading to false because we redirect away
  };
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden bg-background-light">
      ...
      <main className="w-full max-w-md z-10">
        ...
        <div className="bg-white rounded-2xl shadow-soft p-8 sm:p-10 border border-white/50 backdrop-blur-sm">
          <div className="space-y-4">
            <button 
              ...
              className="group w-full flex items-center justify-center gap-3 bg-white border border-gray-100 rounded-lg p-3.5 text-nordic-dark font-medium transition-all duration-300 hover:shadow-soft hover:-translate-y-0.5 relative overflow-hidden disabled:opacity-50 disabled:cursor-not-allowed"
            >
              ...
              {loadingGoogle ? (
                <span className="material-icons animate-spin text-nordic-dark relative z-10">autorenew</span>
              ) : (
              ...
              <span className="relative z-10">{loadingGoogle ? "Connecting..." : "Continue with Google"}</span>
            </button>
            <button 
            ...
            >
              ...
              <span className="relative z-10">{loadingGithub ? "Connecting..." : "Continue with GitHub"}</span>
            </button>
          </div>
        ...
        <div className="mt-8 text-center">
          <nav className="flex justify-center gap-6 text-xs text-nordic-muted/80">
